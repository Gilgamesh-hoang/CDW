  ...
  return (
    <footer className="w-full bg-[#291D4C] text-white py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-6">
          <p className="mb-4">
            Với nhiều năm kinh nghiệm trong nghề, chúng tôi cung cấp nền tảng hệ
            thống để triển khai các chiến dịch Marketing và Chiến lược kinh
            doanh tốt và sát thực tiễn nhất cho quý đối tác, công ty, doanh
            nghiệp.
          </p>
          <p className="mb-8">
            Phù hợp với marketing Online trên đa nền tảng, với số lượng cộng tác
            viên đông đảo và nhiệt tình, nhanh nhẹn.
          </p>
        </div>
