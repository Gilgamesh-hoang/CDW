            ...
            nav.path && (
              <Link
                ...
                className={`relative flex items-center w-full gap-3 px-3 py-2 font-medium rounded-lg text-sm leading-5 group ${
                  isActive(nav.path) ? 'bg-[#ecf3ff] text-[#465fff]' : 'text-gray-700 hover:bg-gray-100 group-hover:text-gray-700 '
                }`}
              >
                <span
                  className={isActive(nav.path) ? 'text-[#465fff]' : 'text-gray-500 group-hover:text-gray-700'}
                >
                  {nav.icon}
                </span>
