        ...
        <ComponentCard title="Danh sách đơn hàng">
          <div>
                    ...
                    {orders && orders.map((order) => (
                      <TableRow key={order.id}>
                        ...
                        <TableCell className="text-gray-500 ">
                          <button className="p-3 hover:text-red-500 cursor-pointer"
                                  onClick={() => {
                                    navigate(ROUTES.ADMIN_ORDER_DETAIL.replace(':id', order.id.toString()));
                                  }}
                          >
            ...
            <div className="mt-12 flex justify-center">
              <Pagination totalPage={totalPage} currentPage={currentPage} setCurrentPage={setCurrentPage} pathname={ROUTES.ADMIN_ORDER} />
            </div>
          </div>
        </ComponentCard>
      </div>
